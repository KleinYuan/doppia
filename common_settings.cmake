...
if(HOSTED_AT_VISICS GREATER -1)
  ...
  set(local_CUDA_CUT_INCLUDE_DIRS "/usr/local/cuda-8.0/include")
  set(local_CUDA_CUT_LIBRARY_DIRS "/usr/local/cuda-8.0/lib")
...
elseif(${HOSTNAME} STREQUAL  "sammy")
  ...
  set(local_CUDA_LIB_DIR "/usr/local/cuda-8.0/lib")
  set(cuda_LIBS "cuda")
